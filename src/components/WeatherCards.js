...
class WeatherCards extends Component {
  ...
  render() {
    ...
    let dateArray = this.props.day.dt_txt
      .split(" ")[0]
      .split("-")
      .map(n => {
        return parseInt(n);
    ...
    let daDate = new Date(dateArray[0], dateArray[1] - 1, dateArray[2]);
    let dateSplit = daDate
      .toString()
      .split(" ")
      .splice(0, 3)
      .join(" ");
    ...
    return (
      <div className="ui card" style={this.style} onClick={this.getDay}>
        <div className="content">
          ...
          {/* <i style={this.thing} class={this.weatherSymbol()} /> */}
          ...
          <h4>
            {" "}
            Temperature:{" "}
            {Math.round(((this.props.day.main.temp - 273.15) * 9) / 5 + 32)} ° F
          </h4>
          <h4>
